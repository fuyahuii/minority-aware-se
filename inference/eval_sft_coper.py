...
def main():
    ...
    parser.add_argument('--base4bit', action='store_true', help="whether to use 8-bit or 4-bit quantization for the base model")
    ...
    # logging file
    setup_logging(log_path, log_filename="log.txt")
